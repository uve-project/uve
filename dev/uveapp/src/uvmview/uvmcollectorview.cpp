...
UvmCollectorView::UvmCollectorView(UvmComponentView* parent, UvmComponent * model, MainWindow * mainwindow) :
...
void UvmCollectorView::calculRect()
{
...
// Paint the collector
void UvmCollectorView::paint(QPainter *painter, const QStyleOptionGraphicsItem* option, QWidget *widget)
{
...
// Get the type name of the collector
QString UvmCollectorView::getTypeName()
{
    return "Collector";
}

void UvmCollectorView::placePorts()
{
    foreach(UvmPortView* pv, getPortsViews())
    {
        if(pv->getModel()->getConnectedComponentType() == MONITOR)
        {
...
void UvmCollectorView::untangleConnections()
{
