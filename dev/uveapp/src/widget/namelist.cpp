...
void NameList::append(const QString &name, void *object)
{
...
void NameList::remove(const QString &name)
{
...
void NameList::removeAt(uint place)
{
...
void NameList::replace(const QString &oldName, const QString &newName, void *newValue)
{
    //Simple search
    int i;
...
void NameList::setTitle(const QString &title)
{
    _title->setText(title);
}

// Fetch from the GUI
QString NameList::getTitle() const
{
    return _title->text();
}

// Show/hide the up/down buttons
void NameList::hideUpDown(bool hide)
{
    b_up->setHidden(hide);
    b_down->setHidden(hide);
}

void NameList::hideLoad(bool hide)
{
    b_load->setHidden(hide);
}

void NameList::hideAdd(bool hide)
{
    b_add->setHidden(hide);
}

// Fetch directly from the GUI, hmmm, fresh!
bool NameList::isUpDownHidden() const
{
    return b_up->isHidden();
}

bool NameList::isLoadHidden() const
{
    return b_load->isHidden();
}

bool NameList::isAddHidden() const
{
...
void NameList::selectIndex(QModelIndex i)
{
    emit selected(i.row());
}

void NameList::activateIndex(QModelIndex i)
{
    emit activated(i.row());
}

void NameList::paintItemRed(uint place, bool red)
{
    if(red)
    {
