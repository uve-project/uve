...
*/
#ifndef NAMEANDNUMBERLIST_H
#define NAMEANDNUMBERLIST_H
...
class NameAndNumberList : public QWidget
{
    Q_OBJECT
public:
    explicit NameAndNumberList(QWidget *parent = 0);
