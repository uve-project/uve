...
*/
#ifndef UVMSEQUENCER_H
#define UVMSEQUENCER_H

#include "uvmcomponent.h"
#include "uvmvirtualsequencer.h"

/**
  * This class represent an UVM Sequencer.
  */
class UvmSequencer : public UvmComponent
{
    UVMCOMPONENT_UTILS

    public:
        UvmSequencer(UvmComponent *parent=0);
